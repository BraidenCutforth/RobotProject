...
/*
------------------ CODE NOTES -------------------------------------------------------------------------------------
This code was written by Group 144 Section B06 (Braiden Cutforth,
Ryan Ferguson,and Marco Agostini) with the monitorLight(); function
adapted from code provided to us on coursespaces.
-------------------------------------------------------------------------------------------------------------------
*/
